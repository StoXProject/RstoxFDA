...
context("test-StoxBaselineFunctions: FilterAgeLengthOutliers")
...
filt <- FilterAgeLengthOutliers(StoxBioticCod, Linf = 232.98028344, K=0.05284384, sigma=0.16180306, kAl=4)
...
filt <- FilterAgeLengthOutliers(StoxBioticCod, Linf = 232.98028344, K=0.05284384, sigma=0.16180306, kAl=1)
expect_true(nrow(filt$Individual) < nrow(StoxBioticCod$Individual))
expect_equal(nrow(filt$Station), nrow(StoxBioticCod$Station))
filt <- FilterAgeLengthOutliers(StoxBioticCod, Linf = 232.98028344, K=0.05284384, sigma=0.16180306, kAl=.01, FilterUpwards = T)
expect_true(nrow(filt$Individual) < nrow(StoxBioticCod$Individual))
