...
resultsWlength <- RunRecaModels(paramOut, StoxLandingData, GroupingVariables = "Gear", CollapseLength = F, Seed = 125)
results <- RunRecaModels(paramOut, GroupingVariables = "Gear", StoxLandingData, Seed = 126)
