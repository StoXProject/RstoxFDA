...
expect_equal(attr(SamplingReport$FisheriesSampling$WeightOfSampledCatches, "unit"), "kg")
expect_null(attr(SamplingReport$FisheriesSampling$Catches, "unit"))

SamplingReportKt <- ReportFdaSampling(StoxBioticData, StoxLandingData, GroupingVariables = c("Quarter"), Unit="kt")
...
expect_equal(attr(SamplingReportKt$FisheriesSampling$WeightOfSampledCatches, "unit"), "kt")
expect_equal(attr(SamplingReportKt$FisheriesSampling$LandedRoundWeight, "unit"), "kt")
expect_null(attr(SamplingReportKt$FisheriesSampling$Catches, "unit"))
