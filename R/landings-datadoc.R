...
#' @usage data(landings)
#'
#' @format RDB CL-table version 1.3 (\href{https://www.ices.dk/marine-data/Documents/RDB/RDB%20Exchange%20Format.pdf}{RDBES exchange format v 1.13}). Some data types may differ from specification. Notably species, which is formatted as character().
#'
#' @keywords datasets
